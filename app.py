...
# --- Dark theme and styled buttons ---
st.markdown(
    """
    <style>
    /* Dark background with dimmed image */
    .stApp {
...
st.write("Upload an image of your hand or click a button to play!")
...
if user_label is not None:
    ...
    if user_confidence is None:
        # Button click: assume 100% confidence
        user_confidence = 1.0
